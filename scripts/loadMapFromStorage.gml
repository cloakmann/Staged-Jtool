///loadMapFromStorage(content,mapKey)

// Deletes all palette objects and loads a map from file.

var content = argument0,filename = argument1;


var firstBreak = string_pos(chr(10),content);
content = string_copy(content,1,firstBreak);
